...
class EntitiesEditViewTest extends TestCase
{
    /** @test */
    public function it_returns_403_for_user_without_roles()
    {
        ...
        $response = $this->actingAs($this->unauthorizedUser)
            ->call('GET', 'genealabs/laravel-governor/entities/entity/edit');
    ...
    public function it_shows_rules_page_for_user_with_superadmin_role()
    {
        ...
        $response = $this->actingAs($this->superAdminUser)
            ->visit('genealabs/laravel-governor/entities/entity/edit')
            ->see('Roles');
    }
